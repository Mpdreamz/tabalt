...
var filename = "Tabalt.exe";       // The name of the executable to launch - change this to match the file you want to launch at the end of your setup
...
try
{
        ...
        WScript.Echo("Found filename: " + filename + " as fileId:" + fileId);
       ...
       // NEW - START
        ...
        sql = "INSERT INTO CustomAction (Action, Type, Source, Target) VALUES ('VSDCA_Launch', '226', 'TARGETDIR', '[TARGETDIR]\\Tabalt.exe')";
        view = database.OpenView(sql);
        view.Execute();
        view.Close();
